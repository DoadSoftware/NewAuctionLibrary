...
public class Team {
  ...
  @Column(name = "TeamTotalPurse")
  private String teamTotalPurse;
  
  @Column(name = "TeamTotalRTM")
  private String teamTotalRTM;
...
public String getTeamTotalPurse() {
	return teamTotalPurse;
}

public void setTeamTotalPurse(String teamTotalPurse) {
	this.teamTotalPurse = teamTotalPurse;
}

public String getTeamTotalRTM() {
	return teamTotalRTM;
}

public void setTeamTotalRTM(String teamTotalRTM) {
